...
//  JOE SCHMOE OBJECT IS CONSOLE LOGGED
// 2. What is "this" when joe.scopeArrow() is invoked?
//  GLOBAL THIS WHICH IS THE WINDOW APPARENTLY
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions remove the ability to use "this" and if you use "this" with an arrow function, you will get the global variable and you will be unable to recall what you think you are recalling.
